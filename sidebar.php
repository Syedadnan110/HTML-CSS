  ...
  <div class="d-flex" id="wrapper">
      ...
      <div class="bg-black sidebar" id="sidebar-wrapper">
    	...
    	<ul>
    		...
    		<li class='sub-menu'><a href='#'>Members<div class='fa fa-caret-down right'></div></a>
    			<ul>
    				<li><a href='add-member.php'>Add a member</a></li>
    				<li><a href='view-member.php'>View members</a></li>
    			</ul>
    		</li>
